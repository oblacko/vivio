import { PrismaClient, VibeCategory } from '@prisma/client';
...
async function main() {
  ...
  const vibes = [
    ...
    },
    {
      ...
      category: VibeCategory.SEASONAL,
  ...
  for (const vibe of vibes) {
    ...
    if (!existingVibe) {
      ...
      console.log(`✅ Created vibe: ${vibe.title}`);
    } else {
      console.log(`⚠️  Vibe already exists: ${vibe.title}`);
    }
  }
